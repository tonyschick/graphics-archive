...
var margin = {top: -1080, right: 24, bottom: 0, left: 280},
...
d3.tsv("data.tsv", function(error, data) {
  ...
  var bar = svg.selectAll(".bar")
    ...
    bar.append("rect")
      ...
      .attr("x", 0)
      .attr("fill", function(d) { return getColor(d.Total);   })
    ...
    bar.append("text")
        ...
        .text(function(d) { return (d.Total * 100).toFixed(1) + "%"  });
