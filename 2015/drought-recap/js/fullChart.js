...
d3.csv("data/lakelevels.csv", function(error, data) {
  ...
  function stepper(){
    ...
    switch(step) {
          case 0:
           ...
           d3.select("#stepDescription").html('Each line represents one of 63 monitored reservoirs in Oregon and Washington, showing August measurements. You can see how reservoir levels rise <span style="color:#0571b0; font-weight:bold;">above average</span> in wetter summers and drop <span style="color:#ca0020; font-weight:bold;">below average</span> in drier summers.');
          ...
          case 1:
            ...
            d3.select("#stepDescription").html("It was extremely dry in 2015. Most reservoirs were below their summer average, but nine reached their lowest storage on record this summer.");
          ...
          case 2:
            ...
            d3.select("#stepDescription").html("Keep in mind some lakes have a lot of natural variation, and swing far above and far below their overall average each year.");
          ...
          case 3:
            ...
            d3.select("#stepDescription").html("Some don't. And even many of those were well below their average.");
          ...
          case 4:
            ...
            d3.select("#stepDescription").html("Dips like this year's aren't unheard of, though. The mid-2000s, mid-1990s, and each decade before it showed similar rises and falls for many lakes across the Northwest.");
          ...
          case 5:
            ...
            d3.select("#stepDescription").html("Are recent years drier than historic decades? Maybe. The past 50 years of data show reservoirs in the Northwest have dipped below average further and with more frequency since 1990.");
