...
//     .defer(d3.json, "js/ma35_path.json")
//     .defer(d3.json, "js/ma35.geojson")
//     .await(ready);
//
...
//
//   var ewaste = svg.selectAll(".ewaste")
//       .data(electronics)
//       .enter().insert("path", ".graticule")
//       .attr("class", "ewaste")
//       .attr("d", path);
//
//
//   var pinpoints =  svg.selectAll("path.pinpoint")
//       .data(exportSites)
//       .enter().append("path")
//       .attr("class", "pinpoint")
//       .attr("d", path)
